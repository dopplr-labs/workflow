...
export const DefaultApiAxiosParamCreator = function (
  ...
  return {
     ...
     */
    authControllerCreateUser: async (
     ...
     * @throws {RequiredError}
     */
    issuesControllerDeleteIssue: async (
      id: string,
      options: any = {},
    ): Promise<RequestArgs> => {
      // verify required parameter 'id' is not null or undefined
      assertParamExists('issuesControllerDeleteIssue', 'id', id)
      const localVarPath = `/issues/{id}`.replace(
        `{${'id'}}`,
     ...
     * @throws {RequiredError}
     */
    issuesControllerGetIssue: async (
      id: string,
      options: any = {},
    ): Promise<RequestArgs> => {
      // verify required parameter 'id' is not null or undefined
     ...
     * @throws {RequiredError}
     */
    issuesControllerGetIssues: async (
      options: any = {},
    ): Promise<RequestArgs> => {
      const localVarPath = `/issues`
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
     ...
     * @throws {RequiredError}
     */
    userControllerFindCurrentUser: async (
      options: any = {},
    ): Promise<RequestArgs> => {
...
export const DefaultApiFp = function (configuration?: Configuration) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    async authControllerCreateUser(
      createUserDto: CreateUserDto,
      options?: any,
    ): Promise<
      (
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.authControllerCreateUser(
          createUserDto,
          options,
        )
     ...
     * @throws {RequiredError}
     */
    async issuesControllerAddIssue(
      createIssueDto: CreateIssueDto,
      options?: any,
    ): Promise<
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<Issue>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.issuesControllerAddIssue(
          createIssueDto,
          options,
        )
      return createRequestFunction(
     ...
     * @throws {RequiredError}
     */
    async issuesControllerDeleteIssue(
      id: string,
      options?: any,
    ): Promise<
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.issuesControllerDeleteIssue(id, options)
      return createRequestFunction(
        localVarAxiosArgs,
        globalAxios,
        BASE_PATH,
     ...
     * @throws {RequiredError}
     */
    async issuesControllerGetIssue(
      id: string,
      options?: any,
    ): Promise<
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<Issue>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.issuesControllerGetIssue(id, options)
      return createRequestFunction(
        localVarAxiosArgs,
        globalAxios,
        BASE_PATH,
     ...
     * @throws {RequiredError}
     */
    async issuesControllerGetIssues(
      options?: any,
    ): Promise<
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Issue>>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.issuesControllerGetIssues(options)
      return createRequestFunction(
        localVarAxiosArgs,
        globalAxios,
        BASE_PATH,
    ...
    async userControllerFindAll(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<Array<UserWithoutSensitiveData>>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.userControllerFindAll(options)
      return createRequestFunction(
        localVarAxiosArgs,
        globalAxios,
        BASE_PATH,
     ...
     * @throws {RequiredError}
     */
    async userControllerFindCurrentUser(
      options?: any,
    ): Promise<
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<UserWithoutSensitiveData>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.userControllerFindCurrentUser(options)
      return createRequestFunction(
        localVarAxiosArgs,
        globalAxios,
        BASE_PATH,
...
export const DefaultApiFactory = function (
  ...
  return {
    ...
    authControllerCreateUser(
      ...
      return localVarFp
        .authControllerCreateUser(createUserDto, options)
    ...
    issuesControllerAddIssue(
      ...
      return localVarFp
        .issuesControllerAddIssue(createIssueDto, options)
        .then((request) => request(axios, basePath))
    },
    /**
     *
     ...
     * @throws {RequiredError}
     */
    issuesControllerDeleteIssue(
      id: string,
      options?: any,
    ): AxiosPromise<object> {
      return localVarFp
        .issuesControllerDeleteIssue(id, options)
        .then((request) => request(axios, basePath))
    },
    /**
     *
    ...
    issuesControllerGetIssue(id: string, options?: any): AxiosPromise<Issue> {
      return localVarFp
        .issuesControllerGetIssue(id, options)
        .then((request) => request(axios, basePath))
    },
    /**
     *
    ...
    issuesControllerGetIssues(options?: any): AxiosPromise<Array<Issue>> {
      return localVarFp
        .issuesControllerGetIssues(options)
        .then((request) => request(axios, basePath))
    },
    /**
     *
     ...
     * @throws {RequiredError}
     */
    userControllerFindCurrentUser(
      options?: any,
    ): AxiosPromise<UserWithoutSensitiveData> {
      return localVarFp
        .userControllerFindCurrentUser(options)
        .then((request) => request(axios, basePath))
    },
  }
}
...
export class DefaultApi extends BaseAPI {
   ...
   * @memberof DefaultApi
   */
  public issuesControllerAddIssue(
    createIssueDto: CreateIssueDto,
    options?: any,
  ) {
    return DefaultApiFp(this.configuration)
